...
public class FirstPersonController : MonoBehaviour
{
        ...
        if(cameraCanMove)
        {
            if (Input.touchCount > 0)
            {
                for (int i = 0; i < Input.touchCount; i++)
                {
                    ...
                    {
                        yaw += touch.deltaPosition.x * touchSensitivity * 0.02f;
                        pitch += (invertCamera ? touch.deltaPosition.y : -touch.deltaPosition.y) * touchSensitivity * 0.02f;
                    }
                }
            }
            else
            {
                ...
                pitch += (invertCamera ? Input.GetAxis("Mouse Y") : -Input.GetAxis("Mouse Y")) * mouseSensitivity;
            }
    ...
    void FixedUpdate()
    {
        ...
        if (playerCanMove)
        {
            ...
            Vector3 targetVelocity = new Vector3(VirtualJoystick.GetAxis("Horizontal"), 0, VirtualJoystick.GetAxis("Vertical"));
